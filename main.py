...
HF_API_TOKEN = "YOUR_HUGGING" # Replace with your Hugging Face API token
...
multi_text = pd.read_csv('')
multi_sentences = multi_text['sentence'].tolist()

toxicity_text = pd.read_csv('')
...
print("Sample of toxic entries for human evaluation:")
